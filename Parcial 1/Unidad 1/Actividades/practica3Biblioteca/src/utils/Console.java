...
public class Console {
    ...
    public static void progressBar(int speed, int size, int iterator, int total,String iconDone,String iconRemain) {
        for (int i = 0; i <= total; i = i + iterator) {
            progressPercentage(i, total, size,iconDone,iconRemain);
            try {
                Thread.sleep(speed);
            } catch (Exception e) {
            }
     ...
     * @param size
     */
    public static void progressPercentage(int done, int total, int size,String iconDone,String iconRemain) {
